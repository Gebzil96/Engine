...
def get_scene_definition(scene_id: str) -> SceneDefinition:
    ...
    if scene_id == "example_scene":
        from src.engine.scenes.example_scene import build_example_scene, update_example_scene

        return SceneDefinition(build=build_example_scene, update=update_example_scene)
